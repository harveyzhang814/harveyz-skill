...
【平台适配说明】
- 【网页获取工具】→ 替换为 Hermes 平台获取网页 HTML 的工具
- 【Subagent 派发】→ 替换为 Hermes 平台的 subagent 派发机制
- 变量注入 → VAULT_PATH、SKILL_DIR、CHROME_PROFILE 通过 Hermes vars.json 或 env 注入
-->
...
# url-extract（Hermes 平台）

> Hermes 平台适配。核心算法见 `references/core-flow.md`。
