...
def isolated_config(tmp_path, monkeypatch):
    # Use a distinct filename from conftest.py's isolated_store_config fixture
    # (also autouse, also under this same tmp_path) — same-name "config.json"
    # would collide, and this fixture's "config missing" test case specifically
    # needs the path to be absent.
