...
用于验证 BCG 深绿 + lime 配色在各图类型下的视觉效果。
主题文件：`themes/bcg.json`
...
flowchart TD
    ...
    style UP   fill:#06160B,color:#fff,stroke:#081C0E
    style MID  fill:#0C2B15,color:#fff,stroke:#10381B
    style DOWN fill:#18562A,color:#fff,stroke:#1E6C35
    style U1 fill:#96F878,color:#212427,stroke:#78C660
    style U2 fill:#96F878,color:#212427,stroke:#78C660
    style U3 fill:#96F878,color:#212427,stroke:#78C660
    style U4 fill:#96F878,color:#212427,stroke:#78C660
    style M1 fill:#21BF61,color:#fff,stroke:#1A994E
    style M2 fill:#21BF61,color:#fff,stroke:#1A994E
    style D1 fill:#696969,color:#fff,stroke:#545454
    style D2 fill:#696969,color:#fff,stroke:#545454
    style D3 fill:#696969,color:#fff,stroke:#545454
```
...
flowchart TD
    ...
    style ZONE fill:#06160B,color:#fff,stroke:#081C0E
    style A fill:#21BF61,color:#fff,stroke:#1A994E
    style B fill:#696969,color:#fff,stroke:#545454
...
stateDiagram-v2
    direction TB
    classDef opportunity fill:#21BF61,stroke:#1A994E,color:#fff
    classDef hold        fill:#696969,stroke:#545454,color:#fff
