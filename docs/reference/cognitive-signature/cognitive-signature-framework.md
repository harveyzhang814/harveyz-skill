---
name: cognitive-signature-extraction
description: >
  Extract an author's cognitive signature — their characteristic thinking patterns, reasoning
  modes, conceptual framings, and unstated assumptions — from a SINGLE article, delivered as
  calibrated, evidence-anchored hypotheses about the implied author. Use this whenever the user
  wants to analyze HOW an author thinks rather than just what they say: reverse-engineering an
  article's reasoning, surfacing hidden premises or assumptions, profiling an author's mental
  models or cognitive style, mapping argumentative habits, or asking "what does this text reveal
  about the author's mind." Trigger even when phrased as "analyze the logic/thinking behind this
  piece," "what are the author's hidden assumptions," "reverse-engineer how this was reasoned,"
  or "what's this author's intellectual style." Single-article focus; not cross-corpus profiling.
---
...
**产出:** 一批描述层 SIGNATURE_CARD(只填描述层栏)。
